...
class RidgeRegression:
    ...
    def fit_gradient_descent(self, X_train, Y_train, LAMB, lrate = 0.01, max_epoch=100,batch_size=20): #batch_size from 128 to 20
...
W_learned = ridgeRegression.fit_gradient_descent(X_train = feature_train, Y_train = label_train, LAMB = best_LAMBDA)
